...
//     cargo: "",
//     entidad: "",
//     custom_role_id: "", // Nuevo campo para seleccionar el ID del rol
//   });
...
//   const [roles, setRoles] = useState([]); // Lista de roles desde el backend
...
//   //  Obtener custom_roles del backend
//   useEffect(() => {
//     const fetchRoles = async () => {
//       try {
//         const res = await fetch(`${back}/api/custom-roles`, {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
//         });
...
//           blocked: false,
//           role: {
//             connect: [{ id: 1, documentId: "ud3m9vpm1rvra8p31l1rud3m" }],
//           },
//           custom_roles: {
//             connect: [
//               {
//                 id: selectedRole.id,
//                 documentId: selectedRole.documentId,
//               },
//             ],
//           },
//         }),
